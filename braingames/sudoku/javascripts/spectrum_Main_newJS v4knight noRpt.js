 ...
 function placePieceHere(event) //move the active piece into a new position
{
    ...
    if(cellClickedX>=0&&cellClickedY>=0&&cellClickedX<8&&cellClickedY<8){

    console.log("board:"+board);

if(board[cellClickedX][cellClickedY]==1||endGameFlag){
  alert("LOSE!");
  endGameFlag=true;
}
else{
        ...
        if(lineFlag){
        lineStage++;
        let delX = Math.abs(oldDotX-cellClickedX);
        let delY = Math.abs(oldDotY-cellClickedY);
        let moveK = delX+delY;
        if(delX!=0&&delY!=0&&moveK==3){
        changeSingleCells(oldDotX,oldDotY,1);
        console.log("oldDotX:"+oldDotX+ " oldDotY:"+oldDotY);
          oldDotX=cellClickedX;
          oldDotY=cellClickedY;
          changeSingleCells(cellClickedX,cellClickedY,2);
          board[cellClickedX][cellClickedY]=1;
          console.log("cellClickedX:"+cellClickedX+ " cellClickedY:"+cellClickedY);
          ...
          drawGrid();}
            ...
            oldDotX=cellClickedX;
            oldDotY=cellClickedY;
              changeSingleCells(cellClickedX,cellClickedY,1);
              console.log("0cellClickedX:"+cellClickedX+ " 0cellClickedY:"+cellClickedY);
              //removeSingleCells(cellClickedX,cellClickedY);
              drawGrid();
          }
      numberOfClicks();
