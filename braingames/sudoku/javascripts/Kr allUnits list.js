...
for(i=0;i<loopLen;i++){
  ...
  if(sideA[i]==0){//if side A
    ...
    if(i==0){console.log(" unitsA[(i * noOfItems) + 3]="+unitsA[(i * noOfItems) + 3])}
  }
  else{
...
console.log("5:"+"noOfPieces="+noOfPieces+" gerUnits="+gerUnits+" rusUnits="+rusUnits+" neutUnits="+neutUnits)
