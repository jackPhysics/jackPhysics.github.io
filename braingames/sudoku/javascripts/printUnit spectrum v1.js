...
var letOfTile3 = [ "A", "B", "C", "D", "E", "F", "G", "H", "I", "J",
...
function printUnit(n, b, t, id, c0){//n=number of image b=battalion number, t=Total, id=number of unit,
  ...
  colDummy = Math.floor(Math.random() * colNo);
  colorThis = allColors[colDummy];
...
//countOutUnits=0;dumFont=24*unitScale;
  ...
  ctx.textBaseline = "middle";
  ctx.lineWidth = "2";
  ctx.fillText(""+tileLabelsA[noOfImgPrnt],i2*unitSize+100*unitScale,j2*unitSize+110*unitScale, 150);
