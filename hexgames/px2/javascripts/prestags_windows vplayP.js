...
function crt_window(){
	crt=open(crtAddress, "CRT", "toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,width=470,height=350,left=30,top=30");
}

function crtNap_window(){
	crt=open("charts/CRT Waterloo.html", "CRT", "toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,width=470,height=350,left=30,top=30");
}
...
function pdfRules_window(){
	rules=open("rules/Afrika_Korps_3d_ed.pdf", "Rules", "toolbar=0,location=0,directories=0,status=0,menubar=0,scrollbars=1,resizable=1,width=600,height=400,left=50,top=150");
