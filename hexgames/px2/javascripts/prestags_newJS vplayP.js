...
if(keyText==9){ //change leader
    ...
    changeNeutralPic(activeIndex);}
    /*
    else if(unitsA[thisIsA[activeIndex]*noOfItems+10]=="MI"||unitsA[thisIsA[activeIndex]*noOfItems+10]=="LB"
    ||unitsA[thisIsA[activeIndex]*noOfItems+10]=="MC"||unitsA[thisIsA[activeIndex]*noOfItems+10]=="HC"){
      changeUnitA[activeIndex]++;
      console.log("changeUnitA[activeIndex]="+changeUnitA[activeIndex]);
