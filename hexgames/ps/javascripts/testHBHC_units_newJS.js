var situationAddress="situations/testHCSD_sit.html";
...
var setupGameData=new Array();
    setupGameData[0] = "0,0,191,0,0,0,192,215,x, 0,0,195,0,0,0,310,213,x, 0,0,199,0,0,0,209,223,x, 0,0,203,0,0,0,291,228,x, 0,0,169,0,0,0,273,261,x, 0,0,165,0,0,0,211,250,x, 0,0,173,0,0,0,310,233,x, 0,0,161,0,0,0,225,259,x, 0,0,185,0,0,0,252,250,x, 0,0,177,0,0,0,293,248,x, 0,0,181,0,0,0,189,237,x, 0,0,157,0,0,0,248,269,x, 0,0,102,0,0,0,249,504,x, 0,0,121,0,0,0,290,519,x, 0,0,125,0,0,0,212,545,x, 0,0,129,0,0,0,211,521,x, 0,0,133,0,0,0,232,537,x, 0,0,137,0,0,0,252,541,x, 0,0,141,0,0,0,288,542,x, 0,0,153,0,0,0,190,534,x, 0,0,149,0,0,0,271,533,x, 0,0,117,0,0,0,231,511,x, 0,0,113,0,0,0,249,520,x, 0,0,109,0,0,0,276,513,x, 0,0,189,0,0,0,123,204,x, 0,0,1,8,A,0,situations/testHCSD_sit.html";
    setupGameData[1] = "";
    setupGameData[2] = "";
    setupGameData[3] = "";
    setupGameData[4] = "";
...
var unitsA=[
"white/hb.jpg", "HB mf:9 fire:1/2 vp:", "2",  "12", "n",
