...
var setupGameData=new Array();
    setupGameData[0] = "0,0,191,0,0,0,190,210,x, 0,0,256,0,0,0,309,217,x, 0,0,232,0,0,0,212,227,x, 0,0,249,0,0,0,292,226,x, 0,0,169,0,0,0,270,255,x, 0,0,218,0,0,0,209,248,x, 0,0,242,0,0,0,309,239,x, 0,0,215,0,0,0,231,261,x, 0,0,185,0,0,0,250,245,x, 0,0,235,0,0,0,291,246,x, 0,0,225,0,0,0,191,240,x, 0,0,208,0,0,0,250,272,x, 0,0,191,0,0,0,192,215,x, 0,0,253,0,0,0,312,219,x, 0,0,229,0,0,0,214,229,x, 0,0,246,0,0,0,295,229,x, 0,0,169,0,0,0,273,261,x, 0,0,165,0,0,0,211,250,x, 0,0,239,0,0,0,312,241,x, 0,0,212,0,0,0,234,264,x, 0,0,185,0,0,0,252,250,x, 0,0,177,0,0,0,293,248,x, 0,0,222,0,0,0,194,243,x, 0,0,205,0,0,0,252,274,x, 0,0,102,0,0,0,249,504,x, 0,0,121,0,0,0,290,519,x, 0,0,125,0,0,0,212,545,x, 0,0,129,0,0,0,211,521,x, 0,0,133,0,0,0,232,537,x, 0,0,137,0,0,0,252,541,x, 0,0,141,0,0,0,288,542,x, 0,0,153,0,0,0,190,534,x, 0,0,149,0,0,0,271,533,x, 0,0,117,0,0,0,231,511,x, 0,0,113,0,0,0,249,520,x, 0,0,109,0,0,0,276,513,x, 0,0,189,0,0,0,123,204,x, 0,0,1,8,A,0,situations/testHCSD_sit.html";
    setupGameData[1] = "";
    setupGameData[2] = "";
    setupGameData[3] = "";
    setupGameData[4] = "";
...
"black/bw.jpg", "BW mf:5 fire 2/2 vp:", "3", "8", "n",
