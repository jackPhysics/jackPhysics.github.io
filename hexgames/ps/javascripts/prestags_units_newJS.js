...
function normBoard()
{
	 document.getElementById("board").setAttribute("src", "boards/arbelaWider1_turn25.jpg");
}

function setupBoard()
{
	document.getElementById("board").setAttribute("src", "boards/arbelaWider_setup_turn25.jpg");
}

function noHexBoard()
{
	document.getElementById("board").setAttribute("src", "boards/arbelaWider_noHex.jpg");
}
