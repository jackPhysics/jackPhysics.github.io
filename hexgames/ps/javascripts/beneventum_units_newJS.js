var situationAddress="situations/beneventum_sit.html";
...
var multiThisNow = 1;
var swidth=1898*3;//6780; //width of biggest board
...
var noOfPieces=106; //no of pieces in game
var unitTotal=19; //number of types of pieces
var lastIndex=106; //index number of last piece - turn now
var gerNumber=48; //the index number of the first side B piece
var neutNumber=106; //index number of first neutral piece
...
"skyblue/ms.jpg", "MS af:3 mf:3 vp:", "2",  "15", "n",
"skyblue/ps.jpg", "PS af:4 mf:3 vp:", "2", "5", "n",
"skyblue/pp.jpg", "PP af:6 mf:4 vp:", "3", "10", "n",
"skyblue/bi.jpg", "BI af:[6] mf:5 vp:", "3",  "6", "n",
"skyblue/lc.jpg", "LC af:1 mf:9 vp:", "1",  "2", "c",
"skyblue/mc.jpg", "MC af:[3] mf:9 vp:", "2",  "4", "c",
"skyblue/bw.jpg", "BW df:(1) mf:5 fire:2/2 vp:", "3",  "3", "f",
"skyblue/sk.jpg", "SK af:[2] mf:5 fire:2/1 vp:", "3",  "1", "f",
"mint/3l.jpg", "3L combat:+3 radius:1 mf:9 vp:", "2", "1", "l",
"mint/1l.jpg", "1L combat:+9 radius:2 mf:9 vp:", "4", "1", "l",

"pink/ms.jpg", "MS af:3 mf:3 vp:", "2",  "8", "n",
"pink/bi.jpg", "BI af:[6] mf:5 vp:", "3",  "15", "n",
"pink/sd.jpg", "SD af:4 mf:4 vp:", "2", "20", "n",
"pink/lc.jpg", "LC af:1 mf:9 vp:", "1",  "4", "c",
"pink/sk.jpg", "SK af:[2] mf:5 fire:2/1 vp:", "3",  "8", "f",
"pink/1l.jpg", "1L combat:+9 radius:2 mf:9 vp:", "4", "1", "l",
...
var board1 = "boards/beneventum.png";
var board_setup = "boards/beneventum setup.png";
var board2 = "boards/Spartan board All.png";
var board3 = "boards/spartan.jpg";

function normBoard()
{
	 document.getElementById("board").setAttribute("src", "boards/beneventum.png");
}

function setupBoard()
{
	document.getElementById("board").setAttribute("src", "boards/beneventum setup.png");
}
