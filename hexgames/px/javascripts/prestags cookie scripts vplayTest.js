...
function getCookie(){//reload the last move - move gets save in saveWindow2()
      cookieValue = localStorage.playTestPrestagsSave;
      alert("playTestPrestagsSave = " + cookieValue);
      reload2(cookieValue);
}
...
function saveTheLot(t){
  var allText=t;
  localStorage.playTestPrestagsSave = ""+allText;
  return;
  //allText="";
}
