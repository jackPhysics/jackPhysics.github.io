...
//var brdShiftX0 = 220;//
//var brdShiftY0 = 208;//
var brdShiftX = 5.5*hexD;//220;//
var brdShiftY = 6*hexLong;//208;//
var brdShiftX0 = 5.5*hexD;//220;//
var brdShiftY0 = 6*hexLong;//208;//
...
function completeBoard(){
  ...
  var corner1X = 7*hexLong;//238;
  var corner2X = canvW0-8*hexLong;//canvW0-308;
  var corner3X = canvW0-8*hexLong;//canvW0-308;
  var corner4X = 7*hexLong;//238;
  var corner1Y = 8*hexLong;//276
  var corner2Y = 8*hexLong;//276;
  var corner3Y = canvH0-8.5*hexLong;//canvH0-294;
  var corner4Y = canvH0-8.5*hexLong;//294;
