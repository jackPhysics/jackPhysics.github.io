...
//var terrainA = ["Brown", "Tan",  "#832727",  "Blue", "Blue", "Turquoise", "Yellow", "Yellow", "LimeGreen", "Cyan", "Pink"];//this array must be same length as allCOORDSX
...
var coordX0 = 0;//hold original coords
var coordY0 = 0;
var coordX = 0;//holds modified coords
var coordY = 0;
var woodSlopesFlag = false;
var citySlopesFlag = false;
//terrain code
...
var allCOORDSX0 = [hillCOX, woodCOX, mountCOX, lakeCOX, smLakeCOX, swampCOX, cityCOX, beachCOX, slopeCOX, bridgeCOX, fordCOX];
var allCOORDSY0 = [hillCOY, woodCOY, mountCOY, lakeCOY, smLakeCOY, swampCOY, cityCOY, beachCOY, slopeCOY, bridgeCOY, fordCOY];

var allCOORDSX = [hillCOX, woodCOX, mountCOX, lakeCOX, smLakeCOX, swampCOX, cityCOX, beachCOX, slopeCOX, bridgeCOX, fordCOX];
var allCOORDSY = [hillCOY, woodCOY, mountCOY, lakeCOY, smLakeCOY, swampCOY, cityCOY, beachCOY, slopeCOY, bridgeCOY, fordCOY];
...
function initBoard(){
  ...
  //loadTerrain(redBno,flipBrdNoR,mirrBrdNoR);
   ...
   allCOORDSY = [hillCOY, woodCOY, mountCOY, lakeCOY, smLakeCOY, swampCOY, cityCOY, beachCOY, slopeCOY, bridgeCOY, fordCOY];
    allBoardArr = create2DArray(110,110);
    allCOORDSX0 = [hillCOX, woodCOX, mountCOX, lakeCOX, smLakeCOX, swampCOX, cityCOX, beachCOX, slopeCOX, bridgeCOX, fordCOX];
    allCOORDSY0 = [hillCOY, woodCOY, mountCOY, lakeCOY, smLakeCOY, swampCOY, cityCOY, beachCOY, slopeCOY, bridgeCOY, fordCOY];
   //allCOORDSX = [hillCOX, slopeCOX, mountCOX, lakeCOX, smLakeCOX, swampCOX, cityCOX, beachCOX, woodCOX, bridgeCOX, fordCOX];
  //allCOORDSY = [hillCOY, slopeCOY, mountCOY, lakeCOY, smLakeCOY, swampCOY, cityCOY, beachCOY, woodCOY, bridgeCOY, fordCOY];
   printBoards(0);
   //printBoards(1);
...
//console.log(""+allBoardArr);
  ...
  coordX0 = allCOORDSX0[l][g];//-1
  if(coordX0<0){coordX0=0}
  coordY0 = allCOORDSY0[l][g];
  if(coordY0<0){coordY0=0}
...
//console.log("coordX0="+coordX0);
  if(allBoardArr[coordX0][coordY0]==0&&l==1){//if woods
  //if(l!=1&&!jumpArrayFlag){//if not slopes
    ////console.log(coordX);
  allBoardArr[coordX0][coordY0]=l;
//console.log("l="+l+" X0="+coordX0+" Y0="+coordY0+" allBoardArr[X0][Y0]="+allBoardArr[coordX0][coordY0])
  //woodSlopesFlag = false;
}
  else if(allBoardArr[coordX0][coordY0]==0&&l==6){//if city
  //if(l!=1&&!jumpArrayFlag){//if not slopes
    ////console.log(coordX);
  allBoardArr[coordX0][coordY0]=l;
//console.log("l="+l+" X0="+coordX0+" Y0="+coordY0+" allBoardArr[X0][Y0]="+allBoardArr[coordX0][coordY0])
  ...
  if(l==8&&allBoardArr[coordX0][coordY0]==1){
      woodSlopesFlag = true;
      //console.log(coordX0+" "+coordY0);
    }
...
*/
  ...
  boardPos = Math.round(dumY*(noXXlines+0)+dumX);
  //if(allTerrainA2[boardPos]!=77){allTerrainA2[boardPos]=l;}
  //if(allBoardArr[coordX0][coordY0]==0){allBoardArr[coordX0][coordY0]=l;}
  //if(allTerrainA2[boardPos]==0){allTerrainA2[boardPos]=l;}
  ...
  ctx.beginPath();
/*
  if (allBoardArr[coordX0][coordY0]==0){
  ...
  */
  if(allBoardArr[coordX0][coordY0]==1&&l==8){//woods on hills
  //else if(allTerrainA2[boardPos]==1&&l==8){//woods on hills
    //allTerrainA2[boardPos]=6;
    ctx.fillStyle =  "DarkGreen";//"Purple";//
    colorNow0 = "DarkGreen";//"Purple";//
    woodSlopesFlag = true;
    citySlopesFlag = false;
  }
  else if(allBoardArr[coordX0][coordY0]==6&&l==8){//city on hills
  //else if(allTerrainA2[boardPos]==1&&l==8){//woods on hills
    //allTerrainA2[boardPos]=6;
    ctx.fillStyle =  "Orange";//"DarkGreen";
    colorNow0 = "Orange";//"DarkGreen";
    citySlopesFlag = true;
    woodSlopesFlag = false;
  }
  ...
  woodSlopesFlag = false;
  if(woodSlopesFlag){
   ctx.fillStyle ="Purple";//"ForestGreen";
   colorNow0="Purple";//"ForestGreen";
  }
  }
  if(l<9){
    var posOrgX = 1;
  ...
  ctx.moveTo(xPos,yPos);
    ...
    colorNow=colorNow0;
    if(lbhFlag){for(tx=0;tx<4;tx++){//hill peaks
  var texWd_x = xPos +Math.round(Math.random()*(hexD)-5);
  var texWd_y = yPos+20+Math.round(Math.random()*10)+(tx*hexLong/4);
  //var texWd_x = xPos +Math.round(Math.random()*(hexD)-5);
  //var texWd_y = yPos+20+Math.round(Math.random()*(hexLong));
...
ctx.fill();
  ...
  ctx.fillStyle = "Maroon";
                ...
                //console.log("l="+l+" X0="+coordX0+" Y0="+coordY0+" allBoardArr[X0][Y0]="+allBoardArr[coordX0][coordY0])
                //if(woodSlopesFlag||allBoardArr[coordX0][coordY0]==1){
                //  colorNow="orange";
                //}
              ...
              //  //console.log("slope:"+dumX+", "+dumY+" "+boardPos+" "+allTerrainA2[boardPos]);
                ...
                if(allBoardArr[coordX0][coordY0]==6){//citySlopesFlag||
                  colorNow=colorNow0;
                for(tx=0;tx<10;tx++){//extra colours
                  colorNow="Maroon";
                  var dirColor = "add";
