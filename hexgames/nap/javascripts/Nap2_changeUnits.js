function dropPoints(id){
  ...
  imageArray[noToDrop].setAttribute("title", "#"+(noToDrop+1)+": "+unitsA[thisIsA[noToDrop]*noOfItems+1]+", "+designateLA[noToDrop]+", "+designateRA[noToDrop]+" Div, "+unitsA[thisIsA[noToDrop]*noOfItems+6]+"-"+unitsA[thisIsA[noToDrop]*noOfItems+7]+" ("+(typeNumbA[noToDrop])+"/"+typeTotalA[noToDrop]+") ");
