...
var seasonA=["06:00", "07:00", "08:00", "09:00", "10:00","11:00","12:00",
...
function placePics() //initialise, add the game pieces to the board
{
  ...
  for(i=0;i<unitTotal+1;i++){
    ...
    if(unitsA[i*noOfItems+5]=="hq"){
	  ...
	  imageArray[noOfImg].setAttribute("title", "#"+(noOfImg+1)+": "+unitsA[i*noOfItems+1]+", "+designateLA[noOfImg]+", "+designateRA[noOfImg]+" Div, "+unitsA[i*noOfItems+6]+"-"+unitsA[i*noOfItems+7]+" ("+(j+1)+"/"+totalNo+") ");
